import { AuthIconButton } from '@/components/forms/buttons/AuthIconButton'
...
const LoginPage = () => {
  return (
    <BasePageLayout>
      <div className="mx-8 flex h-pageHeight flex-col items-center justify-center lg:flex-row">
